...
extension SignUpView {
    var emailField: some View {
        EditTextView(text: $viewModel.email,
                     placeholder: "Insira com seu e-mail *",
...
extension SignUpView {
    var passwordField: some View {
        EditTextView(text: $viewModel.password,
                     placeholder: "Insira com sua senha *",
                     keyboard: .emailAddress,
...
extension SignUpView {
    var documentField: some View {
        EditTextView(text: $viewModel.document,
                     placeholder: "Insira com seu CPF *",
                     keyboard: .numberPad,
                     error: "CPF inválido",
...
extension SignUpView {
    var phoneField: some View {
        EditTextView(text: $viewModel.phone,
                     placeholder: "Insira com seu Telefone com DDD *",
                     keyboard: .numberPad,
...
extension SignUpView {
    var birthdayField: some View {
        EditTextView(text: $viewModel.birthday,
                     placeholder: "Insira sua data de nascimento com DD/MM/YYYY *",
                     keyboard: .default,
                     error: "Data deve conter DD/MM/YYYY",
